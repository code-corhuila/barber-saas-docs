...
> **Nota de contexto:** Este documento es un resumen ejecutivo de apoyo para consulta rápida. Al ser un reporte secundario y no un documento activo de requerimientos, se mantiene almacenado en `99-archive/`.
...
3. **NFR Tooling:** Set up CI/CD pipeline and automated coverage targeting ≥ 80% (NFR-006).
